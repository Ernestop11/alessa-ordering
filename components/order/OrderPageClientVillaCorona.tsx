/**
 * OrderPageClientVillaCorona - Villa Corona Tenant-Specific Order Page
 *
 * This is a COPY of OrderPageClient.tsx specifically for Villa Corona tenant.
...
export default function OrderPageClientVillaCorona({
  sections,
  featuredItems = [],
  tenantSlug,

...
export default function MobileNavDrawer({
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-80 max-w-[85vw] bg-[#1a1a1a] shadow-2xl transform transition-transform duration-300 ease-out ${
      ...
      >
        ...
        {customerData ? (
          ...
          <div className="p-4 border-b border-white/10">
            ...
            <p className="text-center text-xs text-white/50 mt-2">Earn points with every order</p>
          </div>
        )}

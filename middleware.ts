...
export const config = {
  matcher: [
     ...
     */
    // Note: api/track and /track pages have their own tenant validation via URL params
    '/((?!api/auth|api/track|track/|_next/static|_next/image|favicon.ico|robots.txt|tenant/).*)',
  ],
};
